                        ...
                        <tr>
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>                                           
                                        <img src="cid:unique@eahassan.me" alt="EH's logo" width="200" height="200" class="logo"/>
                                            <hr/>
                                            <p>${recipMessage}</p>
                                            <p>Sincerely, <br> Evan H.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
